...
public class ConcertTicketBookingSystemDemo {
    public static void main(String[] args) {
        ...
        bookingSystem.addConvert(concert1);
        ...
        bookingSystem.addConvert(concert2);
        ...
        // Search concerts
        List<Concert> searchResults = bookingSystem.searConvert("Artist 1", "Venue 1", LocalDateTime.now().plusDays(30));
